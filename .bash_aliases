...
alias mced='mcedit -u'
alias alidep='echo alias dependencies: colordiff, curl, dig, elinks, git, glow, jq, lftp, npx, pv, podman, podman-compose, rhash, sipcalc'
alias dmesg='dmesg -H'
alias docker='podman'
...
case "$OS" in
	Darwin)
		...
		alias md5sum='rhash --md5'
		alias md5sum-c='rhash -c'
